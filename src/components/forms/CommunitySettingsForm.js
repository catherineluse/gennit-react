...
import { UPDATE_COMMUNITY, GET_COMMUNITY_WITH_DISCUSSIONS } from '../../graphQLData/communities';
...
const CommunitySettingsForm = ({ currentCommunity }) => {
    ...
    const [updateCommunity, { error }] = useMutation(UPDATE_COMMUNITY, {
        ...
        refetchQueries: useQuery(GET_COMMUNITY_WITH_DISCUSSIONS, {
            variables: {
                url
            }
        })
    ...
    return (
        <div className="container">
            <form onSubmit={handleSubmit}>
                ...
                <span>
                    {renderSubmitButton(updatedSuccessfully)}
                </span>
            </form>
        </div>)
}
